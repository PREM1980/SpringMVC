 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://demo.webservice.com/", wsdlLocation = "http://localhost:8080/HelloWebService/helloWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://demo.webservice.com/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HelloWebService/helloWebService?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://demo.webservice.com/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.webservice.com/", "HelloWebServicePort"), HelloWebService.class, features);
    }
